...
from _get_global_max_value import find_global_max
import logging
...
# define files to create videos from
#npy_paths = [
...
bf_result_folder = "evaluation/out/beamforming_results_25_03_04"
npy_paths = glob.glob(bf_result_folder + "/*/*.npy")
...
global_max = find_global_max(npy_paths)
logging.info(f"Normalization reference value (global max) = {global_max}dB")
...
for path in npy_paths:
    ...
    for band in frequency_bands:
        for camera_pos in camera_postions:
            ...
            video_export(path, name, json_config, band, camera_pos, global_max)
