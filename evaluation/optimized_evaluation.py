...
# avoid lambda function because windows doesn't like it
def process_task(args):
    return calc_audio_frame(*args) # Unpack args and call function

if __name__ == "__main__": #good practice, but mandatory for mutliprocessing with windows
